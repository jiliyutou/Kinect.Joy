...
namespace Kinect.Joy
{
    ...
    internal class KinectHoverButton : KinectButtonBase
    {
        ...
        // Trigger a click 4 times per second
        private const int ButtonRepeatIntervalMilliseconds = 1000 / 2;
        ...
        /// <summary>
        /// Pressed Handler to roll faster
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void OnHandPointerPress(object sender, HandPointerEventArgs e)
        {
            this.repeatTimer.Interval = TimeSpan.FromMilliseconds(ButtonRepeatIntervalMilliseconds / 4);
            e.Handled = true;
        }
        /// <summary>
        ...
        {
            this.repeatTimer.Interval = TimeSpan.FromMilliseconds(ButtonRepeatIntervalMilliseconds);
            e.Handled = true;
        ...
        public void SetTimerInterval(int IntervalMilliseconds)
        {
            this.repeatTimer.Interval = TimeSpan.FromMilliseconds(IntervalMilliseconds);
        }
    }
}
